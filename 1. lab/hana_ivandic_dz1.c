...
void store_image(quant_data *quant, char* output) {
    FILE *fp;
    int i, j, val;
...
int main(int argc, char *argv[]) {
    if (argc != 4) {
        printf("Invalid number of arguments, enter input file, block and output file\n");
        exit(1);
    }

    char *input = argv[1], *output = argv[3];
